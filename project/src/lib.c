...
void Crun(int *loop, int usr) {
  ...
  case 1:
    clone_project("Quick_C_Project_Environment", new_project_name, (char *)NULL, loop);
    break;

  //* Clone the 'C Project Enviornment'
  case 2:
    clone_project("C_Project_Environment", new_project_name, built_sys(), loop);
    break;

  //* Clone the 'C-SDL1.2 Project Enviornment'
  case 3:
    clone_project("C-SDL1.2_Project_Environment", new_project_name, built_sys(), loop);
    break;

  //? ------------------- C++ PROJECTS PART -------------------
  //* Clone the 'Quick C++ Project Enviornment'
  case 4:
    clone_project("Quick_Cpp_Project_Environment", new_project_name, (char *)NULL, loop);
    break;

  //* Clone the 'C++ Project Enviornment'
  case 5:
    clone_project("Cpp_Project_Environment", new_project_name, built_sys(), loop);
    break;

  //* Clone the 'C++-Qt Project Enviornment'
  case 6:
    clone_project("Cpp-Qt_Project_Environment", new_project_name, built_sys(), loop);
    break;
 ...
 * @param flag
 */
void clone_project(char *project_name, char *new_project_name, char *build_sys, int *loop) {
  char cmd[PATH_MAX];
